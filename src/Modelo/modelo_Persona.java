...
public class modelo_Persona {
    ...
    public modelo_Persona(int id_persona,String nombre_persona, String apellido_persona, String domicilio_persona, String telefonoContacto_persona, String emailContacto_persona) {
