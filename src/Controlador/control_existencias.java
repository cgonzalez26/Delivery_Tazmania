...
public class control_existencias {
    ...
    public Object[] combox(String tabla, String campo) {
        return sen.poblar_combox(tabla, campo, "select " + campo + " from " + tabla + " where activo=1;");
    }

    public ArrayList<String> list(String tabla, String campo, String texto) {
        return sen.poblar_list_consulta(campo, "select " + campo + " from " + tabla + " where " + campo + " like '" + texto + "%' and activo=1");
    }

    public ArrayList<String> listaClientes(String texto) {
        return sen.poblar_listclientes_consulta("select dni,nombre,apellido from clientes where dni like '" + texto + "%' and activo=1");
    }

    public Object[] getCatalogos(String tabla, String id, String campo) {
        return sen.poblar_combox_id(tabla, id, campo, "select " + id + "," + campo + " from " + tabla + ";");
    }
